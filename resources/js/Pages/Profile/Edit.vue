            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div class="glass-card p-6">
                        ...
                        <!-- Password Hint -->
                        <div v-if="user?.password_hint" class="mb-4 p-3 rounded-xl bg-amber-50/80 border border-amber-200/60 flex items-start gap-2.5">
                            ...
                            <div>
                                <p class="text-xs font-semibold text-amber-700">Petunjuk Password Anda</p>
                                <p class="text-sm font-mono font-bold text-amber-900 mt-0.5 tracking-wider">{{ user.password_hint }}</p>
                            </div>
                        </div>
                        <form @submit.prevent="updatePassword" class="space-y-4">
                            <div>
                                ...
                                <div class="relative">
                                    <input v-model="passwordForm.current_password" :type="showCurrent ? 'text' : 'password'" class="input-field !pr-10" autocomplete="current-password" required />
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input v-model="passwordForm.password" :type="showPassword ? 'text' : 'password'" class="input-field !pr-10" placeholder="Min. 8 karakter" autocomplete="new-password" required />
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input v-model="passwordForm.password_confirmation" :type="showConfirm ? 'text' : 'password'" class="input-field !pr-10" placeholder="Ketik ulang password baru" autocomplete="new-password" required />
